        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="form theme-form" method="post" action="{{ route('admin.blogs.update',$blog->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="{{ asset('uploads/blogs/'.$blog->image1) }}" class="display-img" alt="" srcset="" id="img-change1" width="50%">
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                 ...
                                 <img src="{{asset('uploads/blogs/'.$blog->image2)}}" class="display-img" alt="" srcset=""
                                 id="img-change2" width="50%">
                            </div>
                        </div>
                        {{-- section 1 --}}
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="meta_keyword" type="text"
                                        placeholder="Meta-Keyword" value="{{ old('meta_keyword',$blog->meta_keyword) }}" >
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="blog_url" type="url"
                                        placeholder="Blog URL" value="{{ old('blog_url',$blog->blog_url) }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="blog_description" id="blog_description" cols="30" rows="10"
                                        placeholder="Enter Blog Description">{!! old('blog_description',$blog->blog_description) !!}</textarea>
                                </div>
                            </div>
                        </div>
                        {{-- section 3 --}}
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="twitter_url" type="url"
                                        placeholder="Twitter URL" value="{{ old('twitter_url',$blog->twitter_url) }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="twitter_description" id="twitter_description" cols="30" rows="10"
                                        placeholder="Enter Twitter Description">{!! old('twitter_description',$blog->twitter_description) !!}</textarea>
                                </div>
                            </div>
                        </div>
