                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.about.documents.index') }}"> Documents </a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <form class="form theme-form" method="post" action="{{ route('admin.about.documents.store') }}"
