                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.about.whoarewe.index') }}">Who are we</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Edit Who are we</h5>
                        </div>
                        @include('admin.layout.includes.message')
                        <form class="form theme-form" method="post" action="{{ route('admin.about.whoarewe.update', $data->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if (!empty($data->image))
                                            <img src="{{ asset('uploads/about/whoarewe/'.$data->image) }}" class="display-img"
