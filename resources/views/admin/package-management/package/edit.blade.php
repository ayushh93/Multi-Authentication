            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <form class="form theme-form" method="post" action="{{ route('admin.package.packages.update',$package->id) }}"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                                        ...
                                                        @if (count($category->subcategory))
                                                            ...
                                                            @foreach ($subcategories as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @if ($package->subcategory_id == $item->id) selected @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="season" type="text"
                                                ...
                                                value="{{ old('season', $package->season) }}" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="accomodation" type="text"
                                                ...
                                                value="{{ old('accomodation', $package->accomodation) }}" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="elevation" type="text"
                                                ...
                                                value="{{ old('elevation', $package->elevation) }}" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select type="text" name="difficulty" class="form-control" required>
                                                ...
                                                <option value="Easy" 
                                                {{$package->difficulty == "Easy" ? "selected" : "" }}
                                                 {{ old('difficulty') == "Easy" ? "selected" : "" }}>Easy</option>
                                                <option value="Moderate"
                                                {{$package->difficulty == "Moderate" ? "selected" : "" }}
                                                 {{ old('difficulty') == "Moderate" ? "selected" : "" }}>Moderate</option>
                                                <option value="Challenging" 
                                                {{$package->difficulty == "Challenging" ? "selected" : "" }}
                                                {{ old('difficulty') == "Challenging" ? "selected" : "" }}>Challenging</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="group_size" type="text" id="group_size"
                                                placeholder="Group size (Eg:5-15 people)" value="{{ old('group_size', $package->group_size) }}"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="description" cols="30" rows="10"
                                                placeholder="Write description about the package">{!! old('description', $package->description) !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{asset('uploads/package/images/'.$package->image)}}" class="display-img" alt="" srcset=""
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="map">Map Image</label>
                                            <div class="inner-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{asset('uploads/package/maps/'.$package->map)}}" class="display-img" alt="" srcset=""
