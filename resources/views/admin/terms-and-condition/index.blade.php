                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary cart-btn-transform pull-right"
                                href="{{ route('admin.termsandcondition.create') }}">Add Terms and Condition</a>
                        </div>
                                        ...
                                        @isset($data)
                                            ...
                                            <tr>
                                               ...
                                               <td> {!!$item->excerpt!!}</td>
                                                <td class="d-flex">
                                                     {{-- edit data --}}
                                                    <a href="{{ route('admin.termsandcondition.edit', $item->id) }}">
                                                        <button class="btn btn-success btn-sm" style="margin-left: 2px">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                    </a>
                                                    {{-- delete data --}}
                                                    <form action="{{ route('admin.termsandcondition.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
