                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="excerpt" id="excerpt" cols="30" rows="10">{!! $slider->excerpt !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="inner-form">
                                                ...
                                                <img src="{{ asset('uploads/slider/' . $slider->image) }}" class="display-img"
