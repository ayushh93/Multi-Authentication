                                ...
                                <table class="display" id="data-source-1" style="width:100%">
                                    ...
                                    <tbody>
                                        @isset($sliders)
                                            ...
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td> <img src="{{ asset('uploads/slider/' . $slider->image) }}" width="70px"
                                                        height="50px"></td>
                                                <td>{{ $slider->title }}</td>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <form action="{{ route('admin.sliders.destroy', $slider->id) }}"
                                                        ...
                                                        <button type="submit" id="confirm_delete"
                                                            class="btn btn-danger confirm_delete" style="margin-left: 2px" data-name="{{ $slider->title }}">
                                                            <i class="fa-solid fa-trash-can"></i>
                                                        </button>
                                                    </form>
                                                    {{-- <a href="{{ route('admin.sliders.destroy', $slider->id) }}" class="delete-confirm"> delete</a> --}}
                                                </td>
                                            </tr>
                                            @endforeach
                                        @endisset
